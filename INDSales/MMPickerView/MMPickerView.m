...
@property (nonatomic, strong) UIBarButtonItem *pickerCancelButtonItem;
...
@property (copy) void (^onCancelButtonPressed)(NSString *);
...
+(void)pickerUseForCountry: (BOOL)country
{
    [self sharedView].forCountry=country;
}
...
+(void)showPickerViewInView:(UIView *)view
  ...
  [self sharedView].onDismissCompletion = completion;
    [self sharedView].onCancelButtonPressed=completion;
...
-(void)initializePickerViewInView: (UIView *)view
  ...
  _pickerContainerView = [[UIView alloc] initWithFrame:CGRectMake(0.0, _pickerViewContainerView.bounds.size.height - 280.0,view.frame.size.width, 280.0)];
  ...
  UIBarButtonItem *flexibleSpace = [[UIBarButtonItem alloc] initWithBarButtonSystemItem:UIBarButtonSystemItemFlexibleSpace target:nil action:nil];
    ...
    if (!forCountry) {
        _pickerCancelButtonItem=[[UIBarButtonItem alloc] initWithBarButtonSystemItem:UIBarButtonSystemItemCancel target:self action:@selector(canelButtonPressed)];
...
//        _pickerViewBarButtonItem = [[UIBarButtonItem alloc] initWithBarButtonSystemItem:UIBarButtonSystemItemDone target:self action:@selector(dismiss)];
        ...
        _pickerViewBarButtonItem=[[UIBarButtonItem alloc] initWithTitle:@"Send" style:UIBarButtonItemStylePlain target:self action:@selector(dismiss)];
        
        
        _pickerViewToolBar.items = @[_pickerCancelButtonItem,flexibleSpace, _pickerViewBarButtonItem];
  ...
  */
  ...
  //Add pickerView
  _pickerView = [[UIPickerView alloc] initWithFrame:CGRectMake(0.0, 30.0,view.frame.size.width, 216.0)];
