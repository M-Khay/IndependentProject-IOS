...
static CGFloat textMarginHorizontal = 20.0f;
static CGFloat textMarginVertical = 20.0f;
static CGFloat messageTextSize = 15.0;

@synthesize sent, messageLabel, messageView, timeLabel, avatarImageView, balloonView,isSelectable;
...
-(id)initMessagingCellWithReuseIdentifier:(NSString*)reuseIdentifier {
    if (self = [super initWithStyle:UITableViewCellStyleDefault reuseIdentifier:reuseIdentifier]) {
        ...
        /*Time-Label*/
        self.timeLabel.font = [UIFont boldSystemFontOfSize:17.0f];
